...
#
# # def hyber():
# #     print("Hybernation Mode Activating")
# #     # os.system(r'%windir%\system32\rundll32.exe powrprof.dll,SetSuspendState Hibernate')
# #
# #
# # def shut():
# #     print("Shutdown Mode Activating")
...
# e4 = tk.Entry(master)
# e4.insert(END, 'C:/Users/Satya/Desktop/new/')
...
#           command=lambda: create_resource(ti=int(e1.get()), v=variable.get(), inac=int(e2.get()), asleep=int(e3.get()),
#                                           fold=str(e4.get()))).grid(row=7,
#                                                                     column=1,
#                                                                     sticky=tk.W,
#                                                                     padx=10, pady=10)
#
